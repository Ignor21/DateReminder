...
export default class RestoreEmail extends Component {
  render(){
    return (
      <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: 'space-between', flexDirection: 'column' }} style={styles.wrapper}>
        ...
        <View>
          ...
          <View style={styles.main}>
            <View style={styles.textView}>
              <Text style={styles.text}>Введите email, указанный в вашем личном кабинете и мы пришлем код для восстановления</Text>
            </View>
            <View>
              <Input
        ...
        <TouchableOpacity style={styles.loginLink} onPress={() => this.props.navigation.replace('LoginStack')}>
          ...
          <Button 
            text={'Далее'}
            active={true}
            onPress={() => this.props.navigation.navigate('RestoreKey')}
          />
        </View>
      </ScrollView>
    );
